...
/**
 * Empty default used as fallback when live report-data.json cannot be fetched
 * from blob storage. Contains NO demo data — the UI shows empty/loading states
 * instead of misleading fake information.
 */
export const reportData: ZeroTrustAssessmentReport = {
  ...
  TestResultSummary: {
    StoragePassed: 0,
    StorageTotal: 0,
    VmsContainersPassed: 0,
    VmsContainersTotal: 0,
    NetworksPassed: 0,
    NetworksTotal: 0,
    FinOpsPassed: 0,
    FinOpsTotal: 0,
